...
const i18n = {
  ...
  en: {
    ...
    tutorialQuickStartStep1:
      'Visit <a href="https://aistone.ai">https://aistone.ai</a> — no registration required.',
    ...
    tutorialTroubleshootingItem4:
      '<strong>Need support:</strong> Email <a href="mailto:support@aistone.ai">support@aistone.ai</a> or use the in-app feedback form.',
    ...
    tutorialStep1Desc:
      'Open your browser and visit <a href="https://aistone.ai">https://aistone.ai</a>, no registration required to start using.',
    ...
    step1Desc:
      "Visit aistone.ai, choose Image Generation or Voice Synthesis service, no registration required",
    ...
    termsSection14Item1: "Email: legal@aistone.ai",
    ...
    privacySection9Item1: "Email: privacy@aistone.ai",
    ...
    faqA5:
      "You can contact us through the contact information at the bottom of the page or email support@aistone.ai.",
  ...
  zh: {
    ...
    tutorialQuickStartStep1:
      '访问 <a href="https://aistone.ai">https://aistone.ai</a>，无需注册即可使用。',
    ...
    tutorialTroubleshootingItem4:
      '<strong>需要帮助：</strong> 可邮件至 <a href="mailto:support@aistone.ai">support@aistone.ai</a> 或使用站内反馈。',
    ...
    tutorialStep1Desc:
      '打开浏览器访问 <a href="https://aistone.ai">https://aistone.ai</a>，无需注册即可开始使用。',
    ...
    // 使用步骤
    step1Title: "访问平台",
    step1Desc: "访问 aistone.ai，选择图像生成或语音合成服务，无需注册直接使用",
    step2Title: "选择模型",
    step2Desc:
    ...
    termsSection14Item1: "邮箱：legal@aistone.ai",
    ...
    privacySection9Item1: "邮箱：privacy@aistone.ai",
    ...
    contactModal: {
      title: "联系我们",
      content:
        '如果您在使用 AISTONE 的过程中有任何问题或建议，欢迎随时与我们联系！<br><br>我们致力于为用户提供最优质的服务体验，无论是技术问题、功能建议还是合作咨询，我们都将认真对待并及时回复。<br><br>联系方式：<br>• 邮箱：<a href="mailto:support@aistone.ai">support@aistone.ai</a><br>• 官方网站：<a href="https://aistone.ai" target="_blank">https://aistone.ai</a><br>• 技术支持：24/7在线支持<br><br>服务范围：<br>• <b>产品反馈与建议：</b>我们非常重视您的体验和意见，任何功能建议或改进想法都欢迎反馈<br>• <b>技术支持：</b>遇到技术问题或使用障碍，请详细描述您的问题，我们会尽快协助解决<br>• <b>商务合作：</b>如果您有商务合作需求，欢迎通过邮箱联系我们<br>• <b>媒体采访：</b>媒体朋友如需采访或报道，请提前预约<br><br>我们会在1-2个工作日内回复您的信息。感谢您的关注与支持！',
    },
    servicesModal: {
      title: "我们的服务",
      content:
    ...
    faqQ5: "如何反馈问题或建议？",
    faqA5: "可通过页面底部的联系方式或邮箱 support@aistone.ai 反馈。",
